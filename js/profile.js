  ...
  document.write(`
    ...
    <body class="min-h-screen flex flex-col">
        <header class="p-6 flex justify-between items-center border-b border-white/20">
            <div class="relative w-12 h-12 rounded-full border-4 border-green-400 animate-pulse overflow-hidden mr-4">
                <img src="img/zone01-kisumu-a9a10ccd.jpg" alt="Avatar" class="object-cover w-full h-full" />
            </div>
    
            <h1 class="neon">Welcome back, <span id="welcome" class="text-sky-400"></span></h1>
            <button id="logoutButton"
                class="bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white px-4 py-2 rounded-lg font-bold hover:scale-105 transition">Logout</button>
        </header>
    
        <main class="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
            <section class="glass p-6 col-span-2 space-y-4">
                <h2 class="radar-title text-xl font-bold mb-4">Your Data Summary</h2>
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                    <div style="word-wrap: break-word;" class="glass p-3 rounded-lg data-frame">📧 Email: <span id="email"
                            class="font-semibold"></span></div>
                    <div class="glass p-3 rounded-lg data-frame">🕒 Login: <span id="login"></span></div>
                    <div class="glass p-3 rounded-lg data-frame">🌿 Flag: <img id="flag" class="inline w-6 h-4 ml-2"></div>
